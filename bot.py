...
async def send_welcome(message: types.Message):
    ...
    # القائمة بدون واتساب، مع زر السجل المحاسبي الموثق
    ...
    keyboard.add(
        ...
        InlineKeyboardButton(t["ledger"], callback_data="view_ledger"),  # زر السجل المحاسبي الفوري
...
async def process(call: types.CallbackQuery) -> None:
    ...
    # عرض تقرير السجل المحاسبي الرقمي الفوري للشركة
    ...
    if call.data.startswith("bill_"):
        ...
        # تسجيل المعاملة محاسبياً آلياً في السجل الرقمي

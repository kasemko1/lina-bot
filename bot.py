...
# القاموس الشامل للغات الست (الأزرار نظيفة، والرسائل توضح أن البوت تجريبي لحين تأسيس الشركة)
TRANSLATIONS = {
    "ar": {
